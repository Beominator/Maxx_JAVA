...
public class JavaMethod {
	...
	public static void main(String[] args) {
		...
		// 출력내용 - 이순신 : 05.국방
//		Job job = new Job();
//		job.jobGroup(member1.name, member1.job);
//		job.jobGroup(member2.name, member2.job);
//		job.jobGroup(member3.name, member3.job);
//		
...
class DataIdenti{		// 연령대, 직업 분류 등등 데이터 분류를 위한 클래스
	...
	void jobGroup( String name, String job) {
		...
		case "군인": job1 = "05.국방";
			break;
		case "섬유공장사장": job1 = "18.섬유의복";
			break;
		case "기계공학자": job1 = "15.기계";
			break;
		}
		System.out.println(name + " : "+ job1);
	}
