...
public class SendEmail {
	...
	public static void sendEmail(String fromEmail, String title, String content) {
		...
		// 관리자 이메일 계정 설정
		final String adminEmail = "stupid87@naver.com";
		final String password = "9V8LQMQ5K1J7";
		...
		// 문의글이 등록되면 관리자 이메일로 전송되어야한다.
		// 보내는 사람과 받는사람이 필요한데
		// 보내는 사람은 클라이언트이지만 실제 클라이언트 메일에서 발송되는게
		// 아니고 자바에서 발송하는것이기 떄문에
		// 관리자가 보내고 받고를 해야한다.
		...
		try {
			...
			msg.setContent(	// 이메일 내용	
					...
					"문의 글 확인</a> </div>", "text/html;charset=utf-8");
