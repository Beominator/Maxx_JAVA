...
--%>
<%-- useBean
		id : 클래스객체의 주소를 저장 할 참조 변수 
			Music music = new Music();
		clqss : 클래스의 경로 (패키지명 포함)
		scope : 자바 빈 객체가 저장될 영역을 설정(내장객체 중 하나)
				page, request, session, application
				
		setProperty - 자바 빈 객체에 인스턴스변수에 값 저장
...
<%
	request.setCharacterEncoding("UTF-8");		// 한글이 깨지지 않도록 하는 방법. 맨 위에 작성해야함. request 객체에 문자코드 적용(한글깨짐방지)
%>
