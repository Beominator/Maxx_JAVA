<%@page import="java.util.ArrayList, study.*" %>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>

<%-- inquiry.jsp 문의 페이지 스타일 적용하려면 inquiry.css --%>
		...
		<ul id="inquiryList">
			...
			<%
				...
				try{
					...
					while(db.rs.next()){	
						list.add(new Inquiry(db.rs.getInt(1), db.rs.getString(2),db.rs.getString(3),db.rs.getString(4),db.rs.getString(5),db.rs.getString(6),db.rs.getString(7)));
					}
				}catch(Exception e){
					e.printStackTrace();
			...
			<li class = 'list'>
				...
				<span class = "isAnswer">
				<%=iq.getAnswer() == null ? "미답변" : "답변완료" %></span>
			</li>
			<% 
				} 
			%>
